...
import com.blackducksoftware.protecode.sc.jenkins.exceptions.MalformedSha1SumException;
...
/**
 * Must be 40 characters long. This might have nice checks but now it doesn't "sha1sum":
 * "3fcdbdb04baa29ce695ff36af81eaac496364e82"
 */
public class Sha1Sum {
  ...
  /**
   * We will never use the content of the sha1sum as bytes so no point in saving it as the correct type.
   */
  @Getter
